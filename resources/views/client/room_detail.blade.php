    ...
    <div class="container mt-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">{{$room->title}}</a></li>
            </ol>
        </nav>
    </div>
                    ...
                    <div class="col-md-6 pr-1">
                        <div class="info bg-white p-4 mb-3 shadow-sm service-info">
                            ...
                            @foreach ($services as $result)
                                <p><img src="{{ asset('images/' . ($result->image ? $result->image->path : 'default.jpg')) }}"
                                        alt="{{ $result->image ? $result->image->name : 'Default Image' }}"
                                        style="height:20px"> {{ $result->name }}</p>
                            @endforeach
                        </div>
                    </div>
            ...
            <div class="col-md-3">
                <div class="card text-center shadow-sm">
                    <div class="card-body">
                        ...
                        <p class="price font-weight-bold text-danger">{{$room->price_per_night}}đ</p>
