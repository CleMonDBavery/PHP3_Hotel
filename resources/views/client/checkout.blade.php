        ...
        <div class="col-md-8">
            <div class="info bg-white p-4 mb-3 shadow-sm">
                ...
                <form>
                    ...
                    <h5 class="font-weight-bold"><i class="fas fa-credit-card"></i> Phương Thức Thanh Toán</h5>
                    <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-danger btn-block"><i class="fas fa-check"></i> Xác Nhận Đặt Phòng</button>
                </form>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card text-center shadow-sm">
                <div class="card-body">
                    ...
                    <p class="price font-weight-bold text-danger"><i class="fas fa-money-bill-wave"></i> Tổng tiền: 2.000.000đ</p>
                </div>
            </div>
        </div>
    </div>
